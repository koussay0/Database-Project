...
def student():
    ...
    if request.method == 'POST':
        if 'update_student' in request.form:
            ...
            cursor.callproc('update_student', [student_id, first_name, last_name, email, dept_id])
            db.commit()
            ...
            cursor.callproc('create_student', [first_name, last_name, email, dept_id])
            db.commit()
        elif 'remove_student' in request.form:
            student_id = request.form.get('remove_student')
...
def timeslot():
    ...
    if request.method == 'POST':
        if 'update_timeslot' in request.form:
            ts_id = request.form.get('timeslot_id')
            day = request.form.get('day')
            start = request.form.get('start_time')
            end = request.form.get('end_time')
            
            cursor.callproc('update_timeslot', [ts_id, day, start, end])
            db.commit()
            ...
            cursor.callproc('create_timeslot', [day, start, end])
            db.commit()
        elif 'remove_timeslot' in request.form:
            ts_id = request.form.get('remove_timeslot')
            cursor.callproc('delete_timeslot', [ts_id])
            db.commit()
